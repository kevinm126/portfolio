...
export const cannedAnswers: { q: RegExp; a: string }[] = [
  {
    ...
    a: `I graduate in 2026 with a B.A. in Data Science from Claremont McKenna College. I'm seeking entry-level Data Science / Software Engineering roles, open to relocation and remote (US).`,
  },
  {
  ...
  {
    q: /.*/,
    a: `Good question. The short version: I'm a Data Science student at Claremont McKenna (Class of 2026) seeking entry-level DS/SWE roles. Ask about my graduation date, strongest project, experience, or résumé, or just grab the PDF at /resume.`,
  },
];
